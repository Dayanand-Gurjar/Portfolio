    ...
    <div className="Intro" id="Intro">
      ...
      <div className="i-left">
        <div className="i-name">
          ...
          <span>Dayanand Gurjar</span>
          <span>
            Full Stack Developer, Problem Solver and enthusiastic Techy with high level of experience in MERN Stack Web Development, producing the quality work
          </span>
        </div>
      ...
      <div className="i-right">
        ...
        >
          ...
          <FloatinDiv img={crown} text1="Problem" text2="Solver" />
        </motion.div>
